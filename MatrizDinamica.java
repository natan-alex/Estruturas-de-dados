...
class MatrizDinamica {
    ...
    public void inserirValor(int item, int linha, int coluna) {
        if (!isColunaELinhaValida(linha, coluna)) {
            System.out.println("Falha na insercao do valor "+item+" em ["+linha+", "+coluna+"] -> Valores de linha ou coluna inválidos.");
            return;
        }
...
class Main{
    public static void main(String[] args) {
        MatrizDinamica m = new MatrizDinamica(2, 5);
        m.inserirValor(10, 0, 0);
        m.inserirValor(20, 2, 3);
        m.removerValor(2, 3);
        m.mostrarItens();
    }
}
